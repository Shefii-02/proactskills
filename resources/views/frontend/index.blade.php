	...
	<div class="container">
		<div class="row align-items-center justify-content-xl-between g-4 g-md-5">
			...
			<div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
				<!-- Badge -->
				<h6 class="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">Get started with Proactskills</h6>
				<!-- Title -->
                 
				<h3 class="mb-4 display-5">Education is the best way to
					<span class="position-relative text-primary d-inline-block">Grow up Knowledge
						<!-- SVG decoration -->
				...
				<div class="row g-3 mb-3 mb-lg-0">
					...
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							...
							<div class="ms-3">
								<div class="d-flex">
									<h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="10" data-purecounter-delay="100">0</h4>
									<span class="h4 mb-0">+</span>
								</div>
								<div>Instructor</div>
							</div>
			...
			<div class="col-lg-5 col-xl-6 text-center position-relative">
				...
				<div class=" position-relative">
					<!-- Yellow background -->
					<div class="bg-primary rounded-4 border border-white border-5 h-200px h-sm-300px shadow"></div>
					<!-- Image -->
					<img src="{{url('assets/images/06.svg')}}" class="position-absolute bottom-0 start-50 translate-middle-x"  alt="">
				</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-5 col-xxl-6 position-relative">
				...
				<h2 class="h1">
					...
					<span class="position-relative z-index-9">Get more close with </span>
					<span class="position-relative z-index-1">Your courses
						<!-- SVG START -->
						<span class="position-absolute top-50 start-50 translate-middle z-index-n1 d-none d-sm-block">
				...
				<p class="mt-4 mb-0">Two before narrow not relied on how except moment myself Dejection assurance Mrs led certainly So gate at no only none open Betrayed. Narrow not relied on how except moment myself Dejection gate at no only none open Betrayed.</p>

				<!-- List -->
				<ul class="list-group list-group-borderless mt-4">
					<li class="list-group-item h6 d-flex fw-normal mb-0"><i class="bi bi-patch-check-fill text-success me-2"></i>You will never think that knowing education</li>
					<li class="list-group-item h6 d-flex fw-normal mb-0"><i class="bi bi-patch-check-fill text-success me-2"></i>Never mess with education and here’s the reason why</li>
					<li class="list-group-item h6 d-flex fw-normal mb-0"><i class="bi bi-patch-check-fill text-success me-2"></i>This is why this year will be the year of education</li>
				</ul>

				<!-- Buttons -->
				<div class="d-sm-flex align-items-center mt-4">
					<!-- Button -->
					<a href="#" class="btn btn-lg btn-dark me-2 mb-4 mb-sm-0">Start Leaning Now</a>
					<!-- Video button -->
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<!-- <div class="bg-danger bg-opacity-10 p-4 p-xl-5 text-center rounded-3 mb-4">
							<h6>Since</h6>
							<span class="h2 text-danger mb-2">1995</span>
						</div> -->

						<!-- Box item -->
						<!-- <div class="bg-light p-4 p-xl-5 text-center rounded-3">
							<span class="h2 text-primary mb-2">26+</span>
							<h6>certified professor</h6>
						</div> -->
                        <img src="/assets/images/about/01.jpg" class="rounded-3 d-none1 d-md-block" alt="">
                                            
                        <img src="/assets/images/about/02.jpg" class="rounded-3 mt-2 d-none d-md-block"  style="height:30%" alt="">
					</div>
					...
					<div class="col-md-8 position-relative mt-5 mt-md-0">
						...
						<!-- Image -->
						<img src="{{url('assets/images/about.jpg')}}" class="rounded-3 d-none d-md-block" alt="">
						<!-- Image -->
						<div class="col-10 position-absolute top-100 start-0 translate-middle mt-n6 ms-n3 d-none d-md-block">
							<!-- <img src="" class="rounded-3" alt=""> -->
                            <div class="card shadow p-0">
                                <div class="overflow-hidden rounded-3">
                                    <img src="{{url('assets/images/about-1.jpg')}}" class="rounded-3" alt="course image">
                                    <!-- Overlay -->
                                    <div class="bg-overlay bg-dark opacity-6"></div>
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Video button and link -->
                                        <div class="m-auto">
                                            <a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg btn-white btn-round mb-0" data-glightbox="" data-gallery="course-video">
                                                <i class="fas fa-play"></i>
                                            </a>
                                        </div>
                                    </div>
					...
					<div class="row position-relative">
						...
						<div class="col-11 mx-auto position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white">Ready to Join!</h3>
								...
								<div class="col-lg-5 text-lg-end">
									<a href="#" class="btn btn-outline-warning mb-0">Join Now</a>
								</div>
							</div>
						</div>
					</div> <!-- Row END -->
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 text-center mx-auto">
				<h2 class="fs-1 mb-0">Our Featured Courses</h2>
			</div>
		</div>
        	<!-- Course Grid START -->
			<div class="row g-4">
					...
					<div class="card shadow h-100">
						...
						<div class="card-body pb-0">
							...
							<div class="d-flex justify-content-between mb-2">
								...
								<a href="#" class="h6 fw-light mb-0">₹ 99</a>
							</div>
							<!-- Title -->
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card shadow h-100">
						...
						<div class="card-body pb-0">
							...
							<div class="d-flex justify-content-between mb-2">
								<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                                <a href="#" class="h6 fw-light mb-0">₹ 99</a>							</div>
							<!-- Title -->
			...
			<div class="col-10 mx-auto">
				<div class="row g-4">
					...
					<div class="tiny-slider arrow-round arrow-dark arrow-hover">
						<div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items="2" data-items-sm="1">
				
							<!-- Testimonial item -->
							<div class="col-6">
								<p class="fs-5">"Make my life easier and organized conviction For every delay in they Extremity now strangers contained breakfast"</p>
								<!-- Avatar -->
								<div class="d-flex align-items-center">
									<!-- Avatar -->
									...
									<div class="ms-2">
										...
										<p class="mb-0 small">Backend developer at google</p>
									</div>
								</div>
							</div>
							...
							<!-- Testimonial item -->
							<div class="col-6">
								<p class="fs-5">"Creating product become fun conviction For every delay in they Extremity now strangers contained breakfast"</p>
								<!-- Avatar -->
								<div class="d-flex align-items-center">
									<!-- Avatar -->
									<div class="avatar avatar-md">
									...
									<div class="ms-2">
										...
										<p class="mb-0 small">Design lead at the agency</p>
									</div>
								</div>
							</div>
							...
							<!-- Testimonial item -->
							<div class="col-6">
								<p class="fs-5">"Conviction For every delay in they Extremity now strangers contained breakfast"</p>
								<!-- Avatar -->
								<div class="d-flex align-items-center">
									<!-- Avatar -->
									<div class="avatar avatar-md">
									...
									<div class="ms-2">
										...
										<p class="mb-0 small">CEO of online shop</p>
									</div>
								</div>
							</div>
						</div>
    ...
    <div class="container">
		...
		<div class="row mt-4 mt-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <p>
                    join and get unlimted offers of the best leaning from us at affordable price and get the course on the same day
                </p>
                <button class="mt-4 d-inline me-3 btn btn-light p-2"><i class="fa fa-google-pay"></i>Play Store</button>

                <button class="mt-4 d-inline me-3  btn btn-light p-2"><i class="fa fa-google-pay"></i>App Store</button>
            </div>
        </div>
